...
const campuses =[
        ...
        },
        {
            ...
            description:"Sunnydale High facilities included a library located around the middle of the school over the exact place of the Hellmouth. The library acted as the Scooby Gang's main base of operations and strangely was not often used by the students with the exception of the more studious."
        },
        {
            name:"The Cafeteria",
        ...
        },
        {
            ...
            description:"The basement level of the school with a boiler room. In 1998, a tunnel was made in the boiler room that led to the location of the Bezoar who used its offspring, distributed via eggs in Health Class, to possess the student body as well as the faculty, and make them mine underground."
